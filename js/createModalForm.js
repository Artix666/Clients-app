...
export const createClientsForm = () => {
  ...
  errorBlock.append(writeName, writeSurname, writeLastName, requiredValue, requiredContacts, unacceptableletter)
  form.append(
    formFloatingSurname,
    formFloatingName,
  ...
  addContactBtn.addEventListener('click', (e) => {
    ...
    document.querySelector('.modal__contact').classList.add('modal__contact--active')
